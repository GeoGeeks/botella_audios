...
Este es un proyecto modular. Puedes:
- Agregar nuevos reproductores de audio duplicando y modificando los existentes
- Cambiar la paleta de colores editando los valores hexadecimales en CSS
- Personalizar el icono de replay usando cualquier imagen PNG/SVG
- Adaptar el widget de fecha para otros idiomas modificando el `locale`

---

## 📄 Licencia

Proyecto educativo/demostrativo para ArcGIS Experience Builder.

---

**Creado por**: Sphirox  
**Proyecto**: Botella al Mar  
